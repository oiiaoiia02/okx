...
const INTENT_KEYWORDS: Record<string, string[]> = {
  market_ticker: ["price", "价格", "行情", "ticker", "btc", "eth", "sol", "查", "look", "check", "实时", "real-time", "quote"],
  market_orderbook: ["orderbook", "订单簿", "depth", "深度", "bid", "ask", "买卖", "book"],
  market_candles: ["candle", "k线", "kline", "chart", "图表", "走势", "周期"],
  market_funding_rate: ["funding", "资金费率", "费率", "perpetual", "rate"],
  market_open_interest: ["open interest", "oi", "持仓量", "interest"],
  market_trades: ["recent trade", "最近成交", "last trade"],
  market_instruments: ["instrument", "产品", "pair", "币对", "list"],
  spot_place_order: ["buy", "sell", "买", "卖", "下单", "order", "交易", "trade", "购买", "现货", "spot"],
  spot_cancel_order: ["cancel", "撤单", "取消"],
  spot_batch_orders: ["batch", "批量", "multiple"],
  spot_algo_order: ["algo", "算法", "conditional", "条件单"],
  swap_place_order: ["swap", "合约", "futures", "期货", "做多", "做空", "long", "short", "杠杆", "leverage", "perp"],
  swap_get_positions: ["position", "持仓", "仓位"],
  swap_set_leverage: ["leverage", "杠杆", "倍数", "margin"],
  swap_tp_sl: ["tp", "sl", "止盈", "止损", "stop", "take profit", "stop loss"],
  swap_trailing_stop: ["trailing", "追踪", "trail"],
  account_balance: ["balance", "余额", "资金", "账户", "account", "钱", "wallet"],
  account_positions: ["portfolio", "投资组合", "所有持仓", "all position"],
  account_bills: ["bill", "账单", "history", "历史"],
  account_fee_rates: ["fee", "手续费", "commission"],
  account_transfer: ["transfer", "划转", "move fund"],
  account_withdrawal: ["withdraw", "提币", "withdrawal"],
  account_deposit_address: ["deposit", "充值", "address", "地址"],
  bot_grid_create: ["grid", "网格", "机器人", "bot"],
  bot_dca_create: ["dca", "定投", "recurring", "auto buy"],
  bot_copy_trading: ["copy", "跟单", "跟随", "copy trade"],
  bot_signal_create: ["signal", "信号"],
  bot_arbitrage: ["arbitrage", "套利"],
  bot_smart_portfolio: ["smart", "智能组合", "rebalance"],
  option_place_order: ["option", "期权"],
  option_greeks: ["greeks", "delta", "gamma", "theta", "vega"],
  option_chain: ["option chain", "期权链"],
  futures_long_short_ratio: ["long short", "多空比", "ratio", "sentiment"],
  futures_liquidation_orders: ["liquidation", "强平", "爆仓"],
};
